  ...
  return (
    <section className="flex flex-col md:flex-row md:mx-0 mx-5 items-center justify-center mt-10">
      ...
      <div className="flex flex-col gap-3 md:w-1/3">
        ...
        <span className="text-neutral-500 text-lg animate-slide-in-to-up-1000">
          Website can&apos;t seem to find the <p className="font-bold inline-block">{text ? text : "page"}</p> you are
          looking for.
        </span>
        <Button
          as={Link}
        ...
        >
          Take Me {text ? text.charAt(0).toUpperCase() + text.slice(1) : "Home"}
        </Button>
      </div>
    </section>
  );
